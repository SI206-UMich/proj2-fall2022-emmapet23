...
.
    ...
    policy_parent = soup.find("ul", class_ = "fhhmddr dir dir-ltr")
    policy_num = policy_parent.find("li", class_ = "f19phm7j dir dir-ltr").text
    # print(policy_num)
    ...
    if "pending" in policy_num.lower():
        ...
        pol = policy_num.strip("Policy number: ")
